...
\textbf{TODO : ajouter diagramme de classe}
...
La technique utilisée consiste à déléguer la gestion complète de la
...
\textbf{TODO : Ajout de PSM\_currentAudioEngine.svg}
\textbf{TODO : Ajout de psm\_currentAudioEngine\_Sequence.svg}
