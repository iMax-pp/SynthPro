...
Ils sont composés de deux options : File et Help, chacun possédant des
sous-menus.
...
\item
  Open : Vous permet de charger un montage que vous auriez au préalable
  sauvegardé.
\item
  Save : Utilisez cette option pour sauvegarder votre montage dans le
  fichier désiré. Vous pourrez ainsi le relire plus tard devant vos
  amis, épatés.
\item
  Play/Pause : Permet de stopper ou de rétablir la lecture du montage.
...
\item
  ...
  développeurs.
\item
  About Qt : Donne des informations relatives au framework utilisé pour
...
que l'on peut trouver dans le menu File, ci-dessus : New, Load, Save,
Exit, et Play/Pause.
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/vco.png}
\caption{VCO}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/vca.png}
\caption{VCA}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/vcf.png}
\caption{VCF}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/adsr.png}
\caption{ADSR}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/lfo.png}
\caption{LFO}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/delay.png}
\caption{Delay}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/mixer.png}
\caption{Mixer}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/sampler.png}
\caption{Sampler}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/oscilloscope.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/keyboard.png}
\caption{Keyboard}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/speaker.png}
\caption{Speaker}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/wavlooper.png}
\caption{WAV Looper}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{../img/png/wavrecorder.png}
\caption{File Output}
\end{figure}
