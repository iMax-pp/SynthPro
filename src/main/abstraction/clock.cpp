...
void Clock::registerFastTimer(TimeCriticalModule* module)
{
    ...
    connect(timer, SIGNAL(timeout()), module, SLOT(fastTimerExpired()));
...
void Clock::unregisterFastTimer(TimeCriticalModule* module)
{
